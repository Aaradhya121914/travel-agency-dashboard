...
import { calculateTrendPercentage } from '~/lib/utilis'
import {cn} from '../app/lib/utilis';

const StatsCard = ({headerTitle,total,lastMonthCount,currentMonthCount}:StatsCard) => {
    const {trend,percentage}=calculateTrendPercentage(lastMonthCount,currentMonthCount);
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                    <figure className='flex items-center gap-1'>
                        <img src={`../public/assets/icons/${isDecrement?"arrow-down-red.svg":"arrow-up-green.svg"}`} alt="arrow" className='size-5'/>
